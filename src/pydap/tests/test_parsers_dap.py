...
def test_jpl1():
    file_path = 'data/daps/20220102090000-JPL-L4_GHRSST-SSTfnd-MUR-GLOB-v02.0-fv04.1_subset.dap'
...
def test_jpl2():
    file_path = 'data/daps/20220531090000-JPL-L4_GHRSST-SSTfnd-MUR-GLOB-v02.0-fv04.1.dap'
    dataset = load_dap(file_path)
    values = dataset['lon'].data[0:5]
    expected = numpy.array([-179.99, -179.98, -179.97, -179.96, -179.95], dtype='float32')
    assert numpy.array_equal(values, expected)
