...
from pydap.virtualizarr.parser import (
    DMRParser,
    DMRPPParser,
)
...
#  https://opendap.github.io/DMRpp-wiki/DMRpp.html#sec-build-them on
#  the files produced by conftest.py with the key matching the fixture name.
DMRPP_XML_STRINGS = {
    "netcdf4_file": textwrap.dedent("""\
        ...
        dapVersion="4.0" dmrVersion="1.0" name="air.nc"
        ...
        (4x/day).  These are the 0.9950 sigma level values.</Value>
            ...
            <Attribute name="build_dmrpp_metadata" type="Container">
                ...
                <Attribute name="invocation" type="String">
                    <Value>
            build_dmrpp -f /usr/share/hyrax/air.nc -r air.nc.dmr -u
             OPeNDAP_DMRpp_DATA_ACCESS_URL -M
                    </Value>
                </Attribute>
            </Attribute>
        </Dataset>
    ...
    "hdf5_groups_file": textwrap.dedent("""\
        ...
        dmrVersion="1.0" name="hdf5_groups_file.nc"
         dmrpp:href="OPeNDAP_DMRpp_DATA_ACCESS_URL"
        dmrpp:version="3.21.1-451">
            <Attribute name="build_dmrpp_metadata" type="Container">
                <Attribute name="created" type="String">
                ...
                <Attribute name="invocation" type="String">
                    <Value>
                    build_dmrpp -f /usr/share/hyrax/hdf5_groups_file.nc
                     -r hdf5_groups_file.nc.dmr
                     -u OPeNDAP_DMRpp_DATA_ACCESS_URL -M</Value>
                </Attribute>
            </Attribute>
            <Group name="test">
                <Group name="group">
    ...
    "fill_value_scalar_no_chunks_nc4_url": textwrap.dedent("""\
        ...
        <Dataset xmlns="http://xml.opendap.org/ns/DAP/4.0#"
        xmlns:dmrpp="http://xml.opendap.org/dap/dmrpp/1.0.0#"
        dapVersion="4.0" dmrVersion="1.0" name="fill_value_scalar_no_chunks.nc4"
        dmrpp:href="OPeNDAP_DMRpp_DATA_ACCESS_URL" dmrpp:version="3.21.1-477">
            <Int32 name="data">
            ...
            <Attribute name="build_dmrpp_metadata" type="Container">
                ...
                <Attribute name="invocation" type="String">
                    <Value>build_dmrpp -f
                     /usr/share/hyrax/fill_value_scalar_no_chunks.nc4
                    -r fill_value_scalar_no_chunks.nc4.dmr
                     -u OPeNDAP_DMRpp_DATA_ACCESS_URL -M</Value>
                </Attribute>
            </Attribute>
        </Dataset>
...
def test_parse_dataset(group: str | None, warns: bool, netcdf4_file):
    """Test migrated from virtualizarr. It needs virtualizarr"""
    from virtualizarr.tests.utils import obstore_local
