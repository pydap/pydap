...
class TestSimpleIterData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.simple_object = IterData(
            ("simple", ("byte", "int", "float")), [
            (0, 1, 10.),
            (1, 2, 20.),
            (2, 3, 30.),
            (3, 4, 40.),
    ...
    def test_iter(self):
        self.assertEqual(
            [tuple(row) for row in self.simple_array], [
            (0, 1, 10.),
            (1, 2, 20.),
            (2, 3, 30.),
            (3, 4, 40.),
    ...
    def test_selection(self):
        ...
        self.assertEqual(
            [tuple(row) for row in selection], [
            (4, 5, 50.),
            (5, 6, 60.),
            (6, 7, 70.),
            (7, 8, 80.),
    ...
    def test_projection(self):
        ...
        self.assertEqual(
            [tuple(row) for row in projection], [
            (1, 2, 20.),
            (3, 4, 40.),
            (5, 6, 60.),
            (7, 8, 80.),
...
class TestNestedIterData(unittest.TestCase):
    ...
    def test_iter(self):
        self.assertEqual(
            [tuple(row) for row in self.nested_object], [
            (1, 1, 1, [(10, 11, 12), (21, 22, 23)]), 
            (2, 4, 4, [(15, 16, 17)]), 
            (3, 6, 9, []), 
            (4, 8, 16, [(31, 32, 33), (41, 42, 43), (51, 52, 53), (61, 62, 63)]), 
