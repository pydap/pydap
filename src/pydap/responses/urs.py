...
def install_basic_client(uri='', user='', passwd='', use_netrc=True):
    ...
    opener.addheaders = [('User-agent', pydap.lib.__version__)]
    ...
    def new_request(url):
        ...
        resp = dict([i[0], i[1]] for i in r.headers.items())
